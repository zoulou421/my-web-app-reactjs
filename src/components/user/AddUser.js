...
export default class AddUser extends Component {
    constructor(props) {
        ...
        this.handeChangeNom=this.handeChangeNom.bind(this);
        this.handeChangePrenom=this.handeChangePrenom.bind(this);
        this.handeChangeEmail=this.handeChangeEmail.bind(this);
        this.handeChangePassword=this.handeChangePassword.bind(this);
        this.handeChangeStatut=this.handeChangeStatut.bind(this);

        this.handeChangeAdd=this.handeChangeAdd.bind(this);
    }
